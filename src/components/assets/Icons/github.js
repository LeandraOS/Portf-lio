...
export const Github = ({color}) => {
  return (
    <LinkAnimation href='https://github.com/LeandraOS/' target='_blank'>
    <svg width="50" height="50" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M40 55V45.325C40.0938 44.1329 39.9327 42.9345 39.5275 41.8095C39.1223 40.6845 38.4823 39.6586 37.65 38.8C45.5 37.925 53.75 34.95 53.75 21.3C53.7493 17.8096 52.4067 14.453 50 11.925C51.1396 8.87129 51.0591 5.4959 49.775 2.50003C49.775 2.50003 46.825 1.62503 40 6.20003C34.27 4.64708 28.23 4.64708 22.5 6.20003C15.675 1.62503 12.725 2.50003 12.725 2.50003C11.4409 5.4959 11.3604 8.87129 12.5 11.925C10.0753 14.4718 8.73131 17.8587 8.75 21.375C8.75 34.925 17 37.9 24.85 38.875C24.0275 39.725 23.3932 40.7385 22.9883 41.8498C22.5834 42.9611 22.417 44.1452 22.5 45.325V55M22.5 47.5C10 51.25 10 41.25 5 40L22.5 47.5Z" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</LinkAnimation>
